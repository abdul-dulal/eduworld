    ...
    <div className="flex lg:justify-between gap-8 flex-wrap justify-center container mt-10">
      <div className="bg-[#F8FBEA] rounded-lg py-16 px-10 space-y-3 lg:w-96 md:w-80 ">
        ...
        <p>
          ...
          subject wise experienced team ensures this support offline or online.
        </p>
      </div>
      <div className="bg-[#F8FBEA] rounded-lg py-16 px-10 space-y-3 lg:w-96 md:w-80">
        <img src={internship} alt="" />
        <h1 className="text-2xl font-serif font-medium">Virtual Internship</h1>
        <p>
          EduWorld has internship opportunities for students. Although virtual,
          there is room to gain real office experience. So after completing the
          course you will get an opportunity to work with industry experts at
          home through virtual internship. Besides, office work is also
          available.
        </p>
      </div>
      <div className="bg-[#F8FBEA] rounded-lg py-16 px-10 space-y-3 lg:w-96 md:w-80">
