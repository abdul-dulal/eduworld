        ...
        <div className="flex lg:justify-between gap-8 flex-wrap justify-center container mt-10">
          ...
          <div className="bg-[#F8FBEA] rounded-lg py-16 px-10 space-y-3 lg:w-96 md:w-80">
            ...
            <p>
              ...
              industry experts at home through virtual internship. Besides,
              office work is also available.
            </p>
          </div>
          <div className="bg-[#F8FBEA] rounded-lg py-16 px-10 space-y-3 lg:w-96 md:w-80">
            <img src={career} alt="" />
            ...
            <p>
              The job placement department works to get the CV to the right
              place according to the students' qualifications. From here you
              will get various seminars on post-course grooming and career
              guidelines. It will put you far ahead of anyone else in the career
              race.
            </p>
          </div>
        </div>
